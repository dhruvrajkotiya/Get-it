										...
										<div class="thumb-description">
											<div class="caption">
												<h4 style="padding-bottom: 0px;">
													<a href="shop/${ItemByGrocery.sk_id }"><b>Item
															Name : </b>${ItemByGrocery.name}</a>
												</h4>
											...
											<div class="button-wrapper">
												...
												<div class="button-group">
													<a href="shop/productdetail/${ItemByGrocery.item_id}"
														class="btn" style="background: black; color: white; border-radius: 7px;" role="button">Item Description</a>
												</div>
											</div>
										</div>
									</div>
