			...
			<div class="row"><jsp:include page="control/sidemenu.jsp"></jsp:include>
				<div id="content" class="col-sm-9">
					...
					<div class="category-products">
						<div class="row">
							<c:forEach items="${ shopitemlist}" var="shopitemlist">
								<div class="product-layout product-list col-xs-12">
									<div class="product-thumb">
										<div class="image">
											<a href="productdetail/${shopitemlist.item_id}"> <img
												class="image_thumb"
												src="${pageContext.request.contextPath}/resources/admin/img/item_images/${shopitemlist.image}"
										...
										<div class="thumb-description">
											<div class="caption">
												<h4 style="padding-bottom: 0px;">
													<a href="productdetail/${shopitemlist.item_id}"><b>Item
															Name : </b>${shopitemlist.name}</a>
												</h4>
												<p class="description" style="margin-bottom: 0px;">
													<b style="color: black;">Item Brand : </b>${shopitemlist.brand}</p>
												<p class="description" style="margin-bottom: 0px;">
													<b style="color: black;">Item Availability : </b>${shopitemlist.availability}</p>
												<p class="description">
													<b style="color: black;">Item Type : </b>${shopitemlist.itemtype}</p>
												<p class="description">
													<b style="color: black;">Item Description : </b><br>${shopitemlist.description}</p>
											</div>
											<div class="button-wrapper">
												<div class="price">
													&#x20b9; ${shopitemlist.offerprice } <i class="price-old">MRP
														:&#x20b9; ${shopitemlist.price }</i>
												</div>
												<div class="button-group">
													<form action="addtocart" method="post">
														<input type="hidden" value="${customer.cust_id }"
															name="cust_id"> <input type="hidden"
															value="${shopitemlist.item_id }" name="item_id">
														<input type=hidden value="${shopitemlist.shop_id }"
															name="shop_id"> <label style="float: left;">Qty</label>
														<input type="text" name="quantity" value="1" size="2"
															style="border-radius: 5px; width: 40px; margin-left: 30px; margin-bottom: 5px; height: 25px;"
															class="form-control">
														<button class="btn-cart" type="submit" title="Add to Cart">
