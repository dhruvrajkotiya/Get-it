...
<title>Shopkeeper | Forgot Password</title>
...
<body>
	...
	<div class="main">
		...
		<div class="container">
			<form method="post" class="appointment-form" id="forgotpassword"
				action="recovery" action="save">

				<h2 style="color: #4966b1; text-align: center;">Get-it
					Shopkeeper Account Recovery</h2>
				...
				<label style="color: black; font-size: 15px;"> Back to </label> <a
					href="login" style="color: black; font-size: 15px;">Sign In</a><br>
			</form>
		</div>
