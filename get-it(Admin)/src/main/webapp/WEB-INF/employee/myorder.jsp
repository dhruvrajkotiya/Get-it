								...
								<div class="col-lg-12">
									<div class="card">
										...
										<div class="card-body">
											<div class="col-md-12">
												...
												<div class="col-md-5" style="float: left;">
													<form action="changedeliverystatus1" method="post">
														...
														<input type="hidden" value="${listitem.del_id }"
															name="del_id"> <select
															class="btn btn-primary m-b-5 m-t-5" name="status">
															<option value="" disabled selected>Select Order
																Status</option>
															<option value="ERS">Reached Shop</option>
															<option value="EPO">Order Picked-up</option>
															<option value="EDO">Order Delivered</option>
														</select> <input type="submit" value="Update Order Status"
										...
										<div class="card-footer">
											<form action="rejectorderbyemployee" method="post">
												<input type="hidden" value="${listitem.del_id }"
													name="del_id"> <input type="hidden"
													value="${listitem.id}" name="mo_id">
												<div class="checkbox">
													<div class="custom-checkbox custom-control"
														...
														<input type="checkbox" data-checkboxes="mygroup"
															...
															style="margin-right: 10px;">Reject Order</label>
													</div>
												</div>
