...
function del(url){
 ...
 function loaddata(id,name,email,password,address,contact,join_date,dob)
   {
	   ...
	   document.f1.join_date.value=join_date;
	   document.f1.dob.value=dob;
									...
									<div class="table-responsive">
										<table
											...
											<c:forEach items="${listemp}" var="listemp">
												<tr>
													<td>${listemp.emp_id}</td>
													<td>${listemp.name}</td>
													<td>${listemp.email}</td>
													<td>${listemp.address}</td>
													<td>${listemp.contact}</td>
													<td>${listemp.join_date}</td>
													<td><div class="btn-group align-top">
															<button class="btn btn-sm btn-primary badge"
																data-target="#editadmin" data-toggle="modal"
																type="button"
																onclick="loaddata(${listemp.emp_id},'${listemp.name}','${listemp.email}','${listemp.password}','${listemp.address}','${listemp.contact}','${listemp.join_date }','${listemp.dob }');">Edit</button>
															<button class="btn btn-sm btn-primary badge"
																type="button" onclick="del('del?id=${listemp.emp_id}')">
						...
						<div class="form-group row mb-0">
							...
							<div class="col-md-9">
								<input class="form-control" type="text" name="join_date"
									id="join_date" required="required" disabled="disabled">
							</div>
						</div>
