...
<title>Admin | Add Shopkeeper</title>
					...
					<div class="row">
						<div class="col-lg-12 ">
							<div class="card">
								...
								<div class="card-body">
									<form class="form-horizontal" action="saveshopkeeper"
										method="post">
										<div class="form-group row">
											<label class="col-md-2 col-form-label">Name</label>
											<div class="col-md-9">
												<input type="text" class="form-control"
													placeholder="Enter shopkeeper name here..." id="name"
										...
										<div class="form-group row">
											...
											<div class="col-md-9">
												<input type="email" id="example-email" name="email"
													class="form-control"
													placeholder="Enter shopkeeper email here..."
													required="required"
										...
										<div class="form-group row">
											...
											<div class="col-md-9">
												<textarea class="form-control" rows="6"
													placeholder="Enter shopkeeper personal address here..."
										...
										<div class="form-group row mb-0">
											...
											<div class="col-md-9">
												<input class="form-control" type="text" name="contact"
													id="contactnumber"
													placeholder="Enter shopkeeper active contact number..."
										...
										<br> <br>
										<div class="form-group row mb-0">
											<label class="col-md-2 col-form-label">Shop
