									...
									<div class="table-responsive">
										<table
											...
											<c:forEach items="${ listuser}" var="listuser">
												<tr>
													<td>${listuser.cust_id}</td>
													<td>${listuser.name}</td>
													<td>${listuser.email}</td>
													<td>${listuser.address}</td>
													<td>${listuser.contact}</td>
													<td><div class="btn-group align-top">
															<button class="btn btn-sm btn-primary badge"
																data-target="#editadmin" data-toggle="modal"
																type="button"
																onclick="loaddata(${listuser.cust_id},'${listuser.name}','${listuser.email}','${listuser.password}','${listuser.address}','${listuser.contact}');">Edit</button>
															<button class="btn btn-sm btn-primary badge"
																type="button"
																onclick="del('deluser?id=${listuser.cust_id}')">
