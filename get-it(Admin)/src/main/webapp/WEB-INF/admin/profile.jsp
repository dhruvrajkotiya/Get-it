							...
							<div class="card">
								...
								<div class="card-body">
									<form class="form-horizontal" method="post" action="update">
										<div class="form-group row">
											...
											<input type="hidden" value="${admin.admin_id }" name="id">
												<input type="text" class="form-control"
													...
													value="${admin.name }" required="required" pattern="[a-zA-Z]{3,30}"
										...
										<div class="form-group row">
											...
											<div class="col-md-9">
												<textarea class="form-control" rows="6" 
													...
													id="address" required="required" minlength="5"
													maxlength="70"
													title="Address minimum length 5 maximum length 70.">${admin.address}</textarea>
											</div>
										</div>
										<div class="form-group row mb-0">
											...
											<div class="col-md-9">
												<input class="form-control" type="text" name="contact"
													id="contact" value="${admin.contact }"
										...
										<label class="lable" style="color: red; margin 10px;"> * In case of change profile You can see updated data after Re-login </label>
