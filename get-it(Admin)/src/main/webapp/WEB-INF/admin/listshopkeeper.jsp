...
<title>Admin | Shopkeeper List</title>
...
<script type="text/javascript">
	...
	function loaddata(id, name, email, password, address, contact, shopkeeperstatus, join_date, shop_id,
			registrationnumber, shopname, shopaddress, shopcontact) {
		...
		document.f1.shopkeeperstatus.value = shopkeeperstatus;
		document.f1.join_date = join_date;
		document.f1.shop_id.value = shop_id;
		document.f1.registrationnumber.value = registrationnumber;
		document.f1.shopname.value = shopname;
		document.f1.shopaddress.value = shopaddress;
		document.f1.shopcontact.value = shopcontact;
...
<body class="app ">
								...
								<div class="card-body">
									<div class="table-responsive">
										<table
											...
											<c:forEach items="${shopkeeperlist}" var="shopkeeperlist">

												<tr>
													<td>${shopkeeperlist.sk_id}</td>
													<td>${shopkeeperlist.name}</td>
													<td>${shopkeeperlist.shopname}</td>
													<td>${shopkeeperlist.email}</td>
													<td>${shopkeeperlist.address}</td>
													<td>${shopkeeperlist.contact}</td>
													<td><div class="btn-group align-top">
															<button class="btn btn-sm btn-primary badge"
																data-target="#editshopkeeper" data-toggle="modal"
																type="button"
																onclick="loaddata(${shopkeeperlist.sk_id},'${shopkeeperlist.name}','${shopkeeperlist.email}','${shopkeeperlist.password}','${shopkeeperlist.address}','${shopkeeperlist.contact}','${shopkeeperlist.shopkeeperstatus}','${shopkeeperlist.join_date }','${shopkeeperlist.shop_id }','${shopkeeperlist.registrationnumber }','${shopkeeperlist.shopname}','${shopkeeperlist.shopaddress }','${shopkeeperlist.shopcontact }');">Edit</button>
															<button class="btn btn-sm btn-primary badge"
																type="button"
																onclick="del('delshopkeeper?id=${shopkeeperlist.sk_id}')">
	...
	<!-- Large Modal -->
	<div id="editshopkeeper" class="modal fade">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content ">
				<div class="modal-header pd-x-20">
					<h6 class="modal-title">Edit and View Shopkeeper Details</h6>
				...
				<div class="modal-body pd-20">
					<form class="form-horizontal" name="f1" method="post"
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<input type="text" class="form-control"
									placeholder="Enter shopkeeper status here..." id="shopkeeperstatus" name="shopkeeperstatus"
									required="required">
							</div>
						</div>
						<br> <br> <br>
						<div class="modal-header pd-x-20">
							<h6 class="modal-title">Edit and View Shop Details</h6>
						</div>
						<br> <br> <input type="hidden" value="" name="shop_id">
						<input type="hidden" value="" name="sk_id">
						<div class="form-group row mb-0">
							<label class="col-md-2 col-form-label">Shop Registration
								Number</label>
							<div class="col-md-9">
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<input type="text" class="form-control"
									placeholder="Enter shop name here..." id="shopname"
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<textarea class="form-control" rows="6"
									...
									id="shopaddress" required="required" maxlength="70"
									minlength="5"
									title="Address minimum length 5 maximum length 70."></textarea>
							</div>
						</div>
						<div class="form-group row mb-0">
							<label class="col-md-2 col-form-label">Shop Contact
								Number</label>
							<div class="col-md-9">
								<input class="form-control" type="text" name="shopcontact"
